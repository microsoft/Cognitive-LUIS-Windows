...
CALL "tools\nuget" restore Runtime.sln
CALL "tools\nuget" restore Programmatic.sln

ECHO.
ECHO # Building .NET solution (release)
CALL "!MsBuildDir!\msbuild" Runtime.sln /t:Clean,Build /p:Configuration=Release
CALL "!MsBuildDir!\msbuild" Programmatic.sln /t:Clean,Build /p:Configuration=Release
